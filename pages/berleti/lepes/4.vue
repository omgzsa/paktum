    ...
    <section class="max-w-2xl mx-auto">
            ...
            <template #hint>
                ...
                >
                    <template #content>
                        ...
                        >
                            A Polgári Törvénykönyv szerint a Bérlő felelőssége a
                            károkért objektív, azaz attól független, hogy neki
                            felróható-e a károkozó magatartás, de bizonyos
                            feltételek esetén mentesülhet.
                        </p>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            Ettől eltérhetsz a Bérlő javára akként, hogy csak
                            akkor lesz felelős a károkért, ha a magatartása neki
                            felróható - ez egy enyhébb felelősségi alakzat.
                        </p>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            A Bérbeadó javára akként térhetsz el, hogy kizárod a
                            Bérlő mentesülésének lehetőségét, azaz ha kár
                            keletkezik a Bérleményben, mindenképpen helyt kell
                            érte állnia.
                        </p>
                    </template>
                </AppTooltip>
        ...
        >
                ...
                >
                    <template #content>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            Azt jelenti, hogy a Bérbeadó a Bérlemény hibájáért
                            felelősséggel tartozik a Bérlő felé. A
                            kellékszavatosság független attól, hogy a Bérbeadó
                            tudott-e a Bérlemény hibájáról, vagy sem.
                        </p>
                    </template>
                </AppTooltip>
            </template>
            <InputRadioBase
                ...
                @update:model-value="
                    (optionId: string) => updateQuestions(optionId, 20)
                "
            />
            <InputRadioBase
                v-model="Q22Value"
        ...
        >
                ...
                >
                    <template #content>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            Azt jelenti, hogy a Bérbeadó felel azért, hogy
                            másnak nincs olyan joga, ami a Bérlőt korlátozná,
                            vagy megakadályozná a Bérlemény használatában. Pl.
                            ha a Bérleményt valaki másnak a haszonélvezeti joga
                            is terheli, e személy korlátozhatja a Bérlőt a
                            Bérlemény használatában, mivel neki is van
                            használatra vonatkozó joga.
                        </p>
                    </template>
                </AppTooltip>
            </template>
            <InputRadioBase
                ...
                @update:model-value="
                    (optionId: string) => updateQuestions(optionId, 21)
                "
            />
            <InputRadioBase
                v-model="Q23Value"
                ...
                >
                    <template #content>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            Azt jelenti, hogy ha a Bérlő nem fizet a
                            Bérbeadónak, a Bérbeadó zálogjogánál fogva a
                            kielégítést kereshet a Bérlő Bérleményben található
                            tárgyaiból. Pl. eladhatja a TV-t, és a befolyt
                            vételárat a Bérlő bérleti díj tartozására
                            számolhatja el.
                        </p>
                    </template>
                </AppTooltip>
        ...
        >
            <InputRadioText
                ...
                :width="45"
                @update:model-value="
                    (optionId: string) => updateQuestions(optionId, 23)
                "
                @update:text-value="
                    (textValue: string) =>
                        updateQuestions(Q25Value, 23, textValue)
                "
            />
            <InputRadioText
                v-model:option="Q25Value"
