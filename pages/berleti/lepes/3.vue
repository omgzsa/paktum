...
const optionsQ15 = [
    ...
    {
        id: 3,
        label: 'az épület és a közös használatú helyiségek tisztántartása',
    },
    {
        id: 4,
    ...
    <section class="max-w-2xl mx-auto">
        ...
        >
            <template #hint>
                ...
                >
                    <template #content>
                        ...
                        >
                            Itt kizárólag azoknak az épülethez kötődő
                            feladatoknak a Bérlő általi elvégzésében lehet
                            megállapodni, amelyek kisebb munka- és
                            költségráfordítással elvégezhetők. Ezek a
                            felsorolásban foglalt feladatok jellegéhez hasonló
                            horderejű tennivalók lehetnek.
                        </p>
                    </template>
                </AppTooltip>
            </template>
            <InputRadioTextCheckedCustom
                ...
                :width="70"
                @update:text-value="
                    (e) => handleCombinedUpdate(Q15Value, 10, { textValue: e })
                "
                @update:checked-values="
                    (e) =>
                        handleCombinedUpdate(Q15Value, 10, { checkedValues: e })
                "
            />
            <InputRadioBase
                v-model="Q15Value"
                ...
                >
                    <template #content>
                        <p
                            class="text-xs font-normal tracking-wide text-neutral-100"
                        >
                            Ez a két bekeretezett kérdés logikailag összefügg,
                            így a választott válaszok együtt mozognak.
                        </p>
                    </template>
                </AppTooltip>
            </template>
