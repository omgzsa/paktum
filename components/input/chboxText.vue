...
<template>
  ...
  >
    ...
    <textarea
      ...
      :disabled="!isChecked"
      rows="1"
      class="max-w-xl h-6 md:h-7 transition-all resize-none overflow-hidden border-none ring-1 focus:ring-paktum-500 md:px-2 md:pb-1.5 hover:border-neutral-950 focus:border-paktum-500 font-bold text-xs dark:bg-neutral-800 dark:text-neutral-100"
