...
export const useContractStore = defineStore('contract', () => {
    ...
    const attachment_NotificationOfModernizationWorks = ref(false) // check
    ...
    const attachment_PreTerminationWarningPayment = ref(false) // check
    const attachment_PreTerminationWarningOther = ref(false) // check
    const attachment_PreTerminationWarningOtherRight = ref(false) // check
    const attachment_TerminationHealthWarning = ref(false) // check
    const attachment_TerminationPropertyConditionProblem = ref(false) // check
    const attachment_TerminationOtherBreachOfContract = ref(false) // check
    const attachment_TerminationLatePayment = ref(false) // check
    const attachment_TerminationModernization = ref(false) // check
    const attachment_TerminationOtherRight = ref(false) // check
    const attachment_OrdenaryTerminationOwner = ref(false) // check
    const attachment_OrdenaryTerminationRenter = ref(false) // check
